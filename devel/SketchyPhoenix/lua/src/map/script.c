...
//-----------------------------------------------------------------------------
// end buildin functions (eascript)
//
...
// NPC interaction
	...
	BUILDIN_DEF(setmapflag,"sii*"),
	BUILDIN_DEF(removemapflag,"sii*"),
	BUILDIN_DEF(editmapflag,"sii*"),
	BUILDIN_DEF(pvpon,"s"),
