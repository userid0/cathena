...
// ギルド作成要求
int mapif_parse_CreateGuild(int fd, int account_id, char *name, unsigned char *buf) {
	struct guild *g;
	int i;
...
// ギルド役職名変更要求
int mapif_parse_GuildPosition(int fd, int guild_id, int idx, unsigned char *buf) {
