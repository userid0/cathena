...
int clif_changemap(struct map_session_data *sd, char *mapname, unsigned short x, unsigned short y);	//self
int clif_changemapserver(struct map_session_data *sd, char *mapname, unsigned short x, unsigned short y, unsigned long ip, unsigned short port);	//self
...
int clif_scriptmes(struct map_session_data *sd, unsigned long npcid, char *mes);	//self
...
int clif_scriptmenu(struct map_session_data *sd, unsigned long npcid, char *mes);	//self
...
int clif_cutin(struct map_session_data *sd, char *image, unsigned char type);	//self
