...
class CAccountDB : public Database
{
protected:
	virtual bool GetAccount(struct account_data& ad, unsigned long account_id);
	virtual bool GetAccount(struct account_data& ad, const char* userid, const char* pass);
...
public:
	...
	struct account_data* GetAccount(const char* userid, const char* pass);
};
