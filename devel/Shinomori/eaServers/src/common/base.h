...
public:
	...
	TArrayDST(const TArrayDST<T>& arr) : cField(NULL),cSZ(0),cCnt(0)	{ ScopeLock scopelock(*this); copy(arr); }
	const TArrayDST& operator=(const TArrayDST<T>& arr)				{ ScopeLock scopelock(*this); copy(arr); return *this;}
	///////////////////////////////////////////////////////////////////////////
...
public:
	...
	TFifoDST(const TFifoDST<T>& arr)					{ ScopeLock scopelock(*this); copy(arr); }
	const TFifoDST& operator=(const TFifoDST<T>& arr)	{ ScopeLock scopelock(*this); copy(arr); return *this; }
...
public:
	...
	TslistDST(const TslistDST<T>& arr,bool ad=false):cAllowDup(ad)	{ copy(arr); }
	const TslistDST& operator=(const TslistDST<T>& arr)				{ copy(arr); return *this; }
