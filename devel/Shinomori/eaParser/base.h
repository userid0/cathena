...
public:
	...
	const TArrayFST& operator=(const TArray<T>& arr)	{ copy(arr); return *this;}
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TfifoFST(const TArray<T>& arr)					{ copy(arr); }
	const TfifoFST& operator=(const TArray<T>& arr)	{ copy(arr); return *this; }
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TstackFST(const TArray<T>& arr)						{ copy(arr); }
	const TstackFST& operator=(const TArray<T>& arr)	{ copy(arr); return *this; }
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TslistFST(const TArray<T>& arr,bool ad=false):cAllowDup(ad)	{ copy(arr); }
	const TslistFST& operator=(const TArray<T>& arr)			{ copy(arr); return *this; }
	...
	{
		ScopeLock scopelock(*this);
		for(size_t i=0; i<cnt && cCnt<SZ; i++)
		{	
			insert( elem[i] );
		}
		return true;
	...
	virtual bool insert(const TArray<T>& list, size_t pos=~0)
	{
		...
		{
			ScopeLock scopelock(*this);
			for(size_t i=0; i<list.size() && cCnt<SZ; i++)
			{
				insert( list[i] );
			}
		}
...
/*
	{	// do a binary search
		...
		bool ret = false;
		size_t a= (startpos>cCnt) ? 0 : startpos;
		size_t b=cCnt-1, c;	//smallest first
...
public:
	...
	const TArrayDST& operator=(const TArray<T>& arr)				{ copy(arr); return *this;}
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TfifoDST(const TArray<T>& arr)					{ copy(arr); }
	const TfifoDST& operator=(const TArray<T>& arr)	{ copy(arr); return *this; }
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TstackDST(const TArray<T>& arr)						{ copy(arr); }
	const TstackDST& operator=(const TArray<T>& arr)	{ copy(arr); return *this; }
...
public:
	...
	const TArrayDCT& operator=(const TArray<T>& arr){ TArrayDST<T>::copy(arr); return *this; }
};
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TfifoDCT(const TArray<T>& arr) : cField(NULL),cSZ(0),cCnt(0){ copy(arr); }
	const TfifoDCT& operator=(const TArray<T>& arr)				{ copy(arr); return *this; }
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TstackDCT(const TArray<T>& arr) : cField(NULL),cSZ(0),cCnt(0)	{ TArrayDST<T>::copy(arr); }
	const TstackDCT& operator=(const TArray<T>& arr)				{ TArrayDST<T>::copy(arr); return *this; }
...
public:
	...
	///////////////////////////////////////////////////////////////////////////
	// copy constructor and assign (cannot be derived)
	TslistDCT(const TArray<T>& arr) : cField(NULL),cSZ(0),cCnt(0)	{ TArrayDST<T>::copy(arr); }
	const TslistDCT& operator=(const TArray<T>& arr)				{ TArrayDST<T>::copy(arr); return *this; }
